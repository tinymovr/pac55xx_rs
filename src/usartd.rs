...
pub struct RegisterBlock {
    #[doc = "0x00 - UART D Receive Buffer / SSP D Control"]
    pub rbr_con: crate::Reg<rbr_con::RBR_CON_SPEC>,
    #[doc = "0x04 - UART D Transmit Holding / SSP D Status"]
    pub thr_stat: crate::Reg<thr_stat::THR_STAT_SPEC>,
    #[doc = "0x08 - UART D Divisor Latch / SSP D Data"]
    pub drl_dat: crate::Reg<drl_dat::DRL_DAT_SPEC>,
    #[doc = "0x0c - UART D Interrupt Enable / SSP D Clock Control"]
    pub ier_clk: crate::Reg<ier_clk::IER_CLK_SPEC>,
    #[doc = "0x10 - UART D Interrupt Identification / SSP D Interrupt Mask Set and Clear"]
    pub iir_imsc: crate::Reg<iir_imsc::IIR_IMSC_SPEC>,
    #[doc = "0x14 - UART D FIFO Control / SSP D Raw Interrupt Status"]
    pub fcr_ris: crate::Reg<fcr_ris::FCR_RIS_SPEC>,
    #[doc = "0x18 - UART D Line Control / SSP D Masked Interrupt Status"]
    pub lcr_mis: crate::Reg<lcr_mis::LCR_MIS_SPEC>,
    #[doc = "0x1c - SSP D Interrupt Clear"]
    pub iclr: crate::Reg<iclr::ICLR_SPEC>,
    #[doc = "0x20 - UART D Line Status"]
    pub lsr: crate::Reg<lsr::LSR_SPEC>,
    _reserved9: [u8; 0x04],
    #[doc = "0x28 - UART D Scratch Pad / SSP D Slave Select Configuration"]
...
#[doc = "UART D Interrupt Enable / SSP D Clock Control"]
pub mod ier_clk;
