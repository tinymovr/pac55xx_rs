...
pub struct RegisterBlock {
    #[doc = "0x00 - UART A Receive Buffer / SSP A Control"]
    pub rbr_con: crate::Reg<rbr_con::RBR_CON_SPEC>,
    #[doc = "0x04 - UART A Transmit Holding / SSP A Status"]
    pub thr_stat: crate::Reg<thr_stat::THR_STAT_SPEC>,
    #[doc = "0x08 - UART A Divisor Latch / SSP A Data"]
    pub drl_dat: crate::Reg<drl_dat::DRL_DAT_SPEC>,
    #[doc = "0x0c - UART A Interrupt Enable / SSP A Clock Control"]
    pub ier_clk: crate::Reg<ier_clk::IER_CLK_SPEC>,
    #[doc = "0x10 - UART A Interrupt Identification / SSP A Interrupt Mask Set and Clear"]
    pub iir_imsc: crate::Reg<iir_imsc::IIR_IMSC_SPEC>,
    #[doc = "0x14 - UART A FIFO Control / SSP A Raw Interrupt Status"]
    pub fcr_ris: crate::Reg<fcr_ris::FCR_RIS_SPEC>,
    #[doc = "0x18 - UART A Line Control / SSP A Masked Interrupt Status"]
    pub lcr_mis: crate::Reg<lcr_mis::LCR_MIS_SPEC>,
    #[doc = "0x1c - SSP A Interrupt Clear"]
    pub iclr: crate::Reg<iclr::ICLR_SPEC>,
    #[doc = "0x20 - UART A Line Status"]
    pub lsr: crate::Reg<lsr::LSR_SPEC>,
    _reserved9: [u8; 0x04],
    #[doc = "0x28 - UART A Scratch Pad / SSP A Slave Select Configuration"]
...
#[doc = "UART A Scratch Pad / SSP A Slave Select Configuration"]
pub mod scr_sscr;
